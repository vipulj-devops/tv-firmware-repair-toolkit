  ...
  return (
    <div className="rounded-xl border border-border bg-card p-3">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
        ...
        <Cell label="Partition table" value={tableType === 'emmc_1630_5840' ? 'eMMC 0x1630/0x5840 Map' : tableType === 'aml_mpt' ? 'Amlogic MPT' : tableType === 'realtek_partinfo' ? 'Realtek PART.INFO' : tableType === 'blkdevparts_mmc' ? 'blkdevparts' : tableType === 'mtdparts_emmc' ? 'mtdparts' : tableType === 'inferred_fs' ? 'Inferred Filesystem' : tableType} />
